...
MERGE (c:TransactConcept {name: 'European Option'})
...
MATCH (c:TransactConcept {name: 'European Option'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Call Option'})
...
MATCH (c:TransactConcept {name: 'Call Option'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Put Option'})
...
MATCH (c:TransactConcept {name: 'Put Option'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Geometric Brownian Motion'})
...
MATCH (c:TransactConcept {name: 'Geometric Brownian Motion'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Log-Normal Distribution'})
...
MATCH (c:TransactConcept {name: 'Log-Normal Distribution'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Risk-Neutral Measure'})
...
MATCH (c:TransactConcept {name: 'Risk-Neutral Measure'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Black-Scholes Model'})
...
MATCH (c:TransactConcept {name: 'Black-Scholes Model'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Implied Volatility'})
...
MATCH (c:TransactConcept {name: 'Implied Volatility'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Volatility Smile'})
...
MATCH (c:TransactConcept {name: 'Volatility Smile'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Stochastic Volatility'})
...
MATCH (c:TransactConcept {name: 'Stochastic Volatility'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Heston Model'})
...
MATCH (c:TransactConcept {name: 'Heston Model'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'CIR Process'})
...
MATCH (c:TransactConcept {name: 'CIR Process'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Feller Condition'})
...
MATCH (c:TransactConcept {name: 'Feller Condition'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Characteristic Function'})
...
MATCH (c:TransactConcept {name: 'Characteristic Function'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'FFT Pricing'})
...
MATCH (c:TransactConcept {name: 'FFT Pricing'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Monte Carlo Simulation'})
...
MATCH (c:TransactConcept {name: 'Monte Carlo Simulation'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Variance Reduction'})
...
MATCH (c:TransactConcept {name: 'Variance Reduction'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Put-Call Parity'})
...
MATCH (c:TransactConcept {name: 'Put-Call Parity'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Greeks'})
...
MATCH (c:TransactConcept {name: 'Greeks'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Delta'})
...
MATCH (c:TransactConcept {name: 'Delta'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Gamma'})
...
MATCH (c:TransactConcept {name: 'Gamma'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Theta'})
...
MATCH (c:TransactConcept {name: 'Theta'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Vega'})
...
MATCH (c:TransactConcept {name: 'Vega'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Rho'})
...
MATCH (c:TransactConcept {name: 'Rho'})
MATCH (m:Menu {name: 'Pricer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Mean-Variance Optimization'})
...
MERGE (c:TransactConcept {name: 'Efficient Frontier'})
...
MATCH (c:TransactConcept {name: 'Efficient Frontier'})
MATCH (m:Menu {name: 'Portfolio'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Global Minimum Variance'})
...
MATCH (c:TransactConcept {name: 'Global Minimum Variance'})
MATCH (m:Menu {name: 'Portfolio'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Tangency Portfolio'})
...
MATCH (c:TransactConcept {name: 'Tangency Portfolio'})
MATCH (m:Menu {name: 'Portfolio'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Sharpe Ratio'})
...
MERGE (c:TransactConcept {name: 'Treynor Ratio'})
...
MATCH (c:TransactConcept {name: 'Treynor Ratio'})
MATCH (m:Menu {name: 'Portfolio'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Sortino Ratio'})
...
MATCH (c:TransactConcept {name: 'Sortino Ratio'})
MATCH (m:Menu {name: 'Portfolio'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Information Ratio'})
...
MATCH (c:TransactConcept {name: 'Information Ratio'})
MATCH (m:Menu {name: 'Portfolio'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'M² Modigliani'})
...
MATCH (c:TransactConcept {name: 'M² Modigliani'})
MATCH (m:Menu {name: 'Portfolio'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Alpha'})
...
MATCH (c:TransactConcept {name: 'Alpha'})
MATCH (m:Menu {name: 'Portfolio'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Beta'})
...
MATCH (c:TransactConcept {name: 'Beta'})
MATCH (m:Menu {name: 'Portfolio'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Systematic Risk'})
...
MATCH (c:TransactConcept {name: 'Systematic Risk'})
MATCH (m:Menu {name: 'Portfolio'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Idiosyncratic Risk'})
...
MATCH (c:TransactConcept {name: 'Idiosyncratic Risk'})
MATCH (m:Menu {name: 'Portfolio'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Skewness'})
...
MATCH (c:TransactConcept {name: 'Skewness'})
MATCH (m:Menu {name: 'Portfolio'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Kurtosis'})
...
MATCH (c:TransactConcept {name: 'Kurtosis'})
MATCH (m:Menu {name: 'Portfolio'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Value at Risk'})
...
MERGE (c:TransactConcept {name: 'Expected Shortfall'})
...
MERGE (c:TransactConcept {name: 'Parametric VaR'})
...
MATCH (c:TransactConcept {name: 'Parametric VaR'})
MATCH (m:Menu {name: 'Risk'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Historical VaR'})
...
MATCH (c:TransactConcept {name: 'Historical VaR'})
MATCH (m:Menu {name: 'Risk'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Monte Carlo VaR'})
...
MATCH (c:TransactConcept {name: 'Monte Carlo VaR'})
MATCH (m:Menu {name: 'Risk'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Square-Root-of-Time'})
...
MATCH (c:TransactConcept {name: 'Square-Root-of-Time'})
MATCH (m:Menu {name: 'Risk'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Feller Condition Violation'})
...
MATCH (c:TransactConcept {name: 'Feller Condition Violation'})
MATCH (m:Menu {name: 'Risk'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Backtesting'})
...
MATCH (c:TransactConcept {name: 'Backtesting'})
MATCH (m:Menu {name: 'Risk'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Black-Litterman Model'})
...
MERGE (c:TransactConcept {name: 'Reverse Optimization'})
...
MERGE (c:TransactConcept {name: 'Bayesian Updating'})
...
MATCH (c:TransactConcept {name: 'Bayesian Updating'})
MATCH (m:Menu {name: 'Optimizer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Kelly Criterion'})
...
MERGE (c:TransactConcept {name: 'Fractional Kelly'})
...
MATCH (c:TransactConcept {name: 'Fractional Kelly'})
MATCH (m:Menu {name: 'Optimizer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Risk Parity'})
...
MERGE (c:TransactConcept {name: 'Equal Risk Contribution'})
...
MATCH (c:TransactConcept {name: 'Equal Risk Contribution'})
MATCH (m:Menu {name: 'Optimizer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Hierarchical Risk Parity'})
...
MERGE (c:TransactConcept {name: 'Correlation Distance'})
...
MERGE (c:TransactConcept {name: 'Single Linkage Clustering'})
...
MATCH (c:TransactConcept {name: 'Single Linkage Clustering'})
MATCH (m:Menu {name: 'Optimizer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Quasi-Diagonalization'})
...
MATCH (c:TransactConcept {name: 'Quasi-Diagonalization'})
MATCH (m:Menu {name: 'Optimizer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Recursive Bisection'})
...
MATCH (c:TransactConcept {name: 'Recursive Bisection'})
MATCH (m:Menu {name: 'Optimizer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Mean-Variance Utility'})
...
MATCH (c:TransactConcept {name: 'Mean-Variance Utility'})
MATCH (m:Menu {name: 'Optimizer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Risk Aversion'})
...
MATCH (c:TransactConcept {name: 'Risk Aversion'})
MATCH (m:Menu {name: 'Optimizer'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Factor Model'})
...
MERGE (c:TransactConcept {name: 'Factor Loading'})
...
MATCH (c:TransactConcept {name: 'Factor Loading'})
MATCH (m:Menu {name: 'Factors'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Fama-French Factors'})
...
MERGE (c:TransactConcept {name: 'Smart Beta'})
...
MERGE (c:TransactConcept {name: 'Factor Momentum'})
...
MATCH (c:TransactConcept {name: 'Factor Momentum'})
MATCH (m:Menu {name: 'Factors'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Crowding'})
...
MATCH (c:TransactConcept {name: 'Crowding'})
MATCH (m:Menu {name: 'Factors'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Idiosyncratic Volatility'})
...
MATCH (c:TransactConcept {name: 'Idiosyncratic Volatility'})
MATCH (m:Menu {name: 'Factors'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Covariance Shrinkage'})
...
MERGE (c:TransactConcept {name: 'Ledoit-Wolf Shrinkage'})
...
MATCH (c:TransactConcept {name: 'Ledoit-Wolf Shrinkage'})
MATCH (m:Menu {name: 'Factors'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Principal Components'})
...
MATCH (c:TransactConcept {name: 'Principal Components'})
MATCH (m:Menu {name: 'Factors'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Scenario Analysis'})
...
MATCH (c:TransactConcept {name: 'Scenario Analysis'})
MATCH (m:Menu {name: 'Scenarios'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Stress Testing'})
...
MATCH (c:TransactConcept {name: 'Stress Testing'})
MATCH (m:Menu {name: 'Scenarios'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Monte Carlo Scenarios'})
...
MATCH (c:TransactConcept {name: 'Monte Carlo Scenarios'})
MATCH (m:Menu {name: 'Scenarios'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Historical Scenarios'})
...
MATCH (c:TransactConcept {name: 'Historical Scenarios'})
MATCH (m:Menu {name: 'Scenarios'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Prospect Theory'})
...
MERGE (c:TransactConcept {name: 'Loss Aversion'})
...
MERGE (c:TransactConcept {name: 'Probability Weighting'})
...
MATCH (c:TransactConcept {name: 'Probability Weighting'})
MATCH (m:Menu {name: 'Scenarios'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Behavioral Portfolio Theory'})
...
MERGE (c:TransactConcept {name: 'Mental Accounting'})
...
MATCH (c:TransactConcept {name: 'Mental Accounting'})
MATCH (m:Menu {name: 'Scenarios'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Implied Volatility Surface'})
...
MATCH (c:TransactConcept {name: 'Implied Volatility Surface'})
...
MERGE (c:TransactConcept {name: 'Volatility Term Structure'})
...
MATCH (c:TransactConcept {name: 'Volatility Term Structure'})
MATCH (m:Menu {name: 'Volatility'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'VIX Index'})
...
MATCH (c:TransactConcept {name: 'VIX Index'})
MATCH (m:Menu {name: 'Volatility'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Variance Risk Premium'})
...
MATCH (c:TransactConcept {name: 'Variance Risk Premium'})
MATCH (m:Menu {name: 'Volatility'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Local Volatility'})
...
MATCH (c:TransactConcept {name: 'Local Volatility'})
MATCH (m:Menu {name: 'Volatility'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Stochastic Volatility Risk Premium'})
...
MATCH (c:TransactConcept {name: 'Stochastic Volatility Risk Premium'})
MATCH (m:Menu {name: 'Volatility'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'SABR Model'})
...
MATCH (c:TransactConcept {name: 'SABR Model'})
MATCH (m:Menu {name: 'Volatility'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Attribution Analysis'})
...
MATCH (c:TransactConcept {name: 'Attribution Analysis'})
MATCH (m:Menu {name: 'Blotter'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Brinson Attribution'})
...
MATCH (c:TransactConcept {name: 'Brinson Attribution'})
MATCH (m:Menu {name: 'Blotter'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Returns-Based Attribution'})
...
MATCH (c:TransactConcept {name: 'Returns-Based Attribution'})
MATCH (m:Menu {name: 'Blotter'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Holdings-Based Attribution'})
...
MATCH (c:TransactConcept {name: 'Holdings-Based Attribution'})
MATCH (m:Menu {name: 'Blotter'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Active Share'})
...
MATCH (c:TransactConcept {name: 'Active Share'})
MATCH (m:Menu {name: 'Blotter'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Tracking Error'})
...
MATCH (c:TransactConcept {name: 'Tracking Error'})
MATCH (m:Menu {name: 'Blotter'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Transaction Costs'})
...
MATCH (c:TransactConcept {name: 'Transaction Costs'})
MATCH (m:Menu {name: 'Blotter'})
MERGE (c)-[:BELONGS_TO]->(m);

MERGE (c:TransactConcept {name: 'Implementation Shortfall'})
...
MATCH (c:TransactConcept {name: 'Implementation Shortfall'})
MATCH (m:Menu {name: 'Blotter'})
MERGE (c)-[:BELONGS_TO]->(m);
